...
cp LICENSE %{buildroot}/usr/share/package-licenses/perl-strictures/LICENSE
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.28.2/strictures.pm
/usr/lib/perl5/vendor_perl/5.28.2/strictures/extra.pm
...
/usr/share/package-licenses/perl-strictures/LICENSE
